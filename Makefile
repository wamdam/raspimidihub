...
$(DEB_FILE): src/raspimidihub/*.py src/raspimidihub/static/*.* $(wildcard src/raspimidihub/static/*/*.*) plugins/*/*.py plugins/*/*.svg systemd/raspimidihub.service udev/90-raspimidihub.rules debian/postinst debian/postrm
	@mkdir -p dist
	@rm -rf $(BUILD_DIR)
