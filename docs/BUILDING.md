...
make deb           # builds dist/raspimidihub_1.0.0-1_all.deb
...
1. `Makefile` — `VERSION = 1.0.0` (used for .deb filename and control file)
2. `src/raspimidihub/__init__.py` — `__version__ = "1.0.0"` (reported in web UI)
